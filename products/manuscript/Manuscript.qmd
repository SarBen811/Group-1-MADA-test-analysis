...
subtitle: ""
author: Group 1 (manuscript by Andreas Handel)
date: "`r Sys.Date()`"
format:
  docx:
    toc: false
...
#| echo: FALSE
knitr::include_graphics(here("results","scatterplot.png"))
```


@fig-boxplot shows a boxplot figure produced by one of the R scripts
```{r}
#| label: fig-boxplot
#| fig-cap: "Height by pet."
#| echo: FALSE
knitr::include_graphics(here("results","boxplot.png"))
```
